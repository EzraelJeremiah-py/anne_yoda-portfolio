...
export default function Home() {
  const [portfolio, setPortfolio] = useState(null);import { useEffect, useState } from "react";
...
export default function Home() {
  ...
  if (!portfolio) return <p style={{ textAlign: "center", marginTop: "2rem", color: "purple" }}>Loading...</p>;
